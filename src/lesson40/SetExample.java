...
public class SetExample {
    ...
    public static void main(String[] args) {
        ...
        set = new HashSet<>(20);
        set = new HashSet<>(List.of(1, 2, 3, 4, 5, 6, 5, 3));
        ...
        startValues = new ArrayList<>(List.of(15, 1, 2, 3, 4, 3, 8, 6, 15, 7, 0, 16, 32));
        System.out.println(startValues);

        // HashSet не поддерживает порядко добавления элементов
        integers = new HashSet<>(startValues);
        System.out.println("integers hashSet: " + integers);

        // LinkedHashSet сохраняет порядок добавления элементов
        linkedSet = new LinkedHashSet<>(startValues);
        System.out.println("linkedSet: " + linkedSet);
